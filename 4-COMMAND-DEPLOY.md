...
4. **Prepare your values:**
   ...
   - GitHub repo name: `_________________`
...
```bash
git clone https://github.com/YOUR_USERNAME/ncwm_chatbot_2.git
cd ncwm_chatbot_2
```
...
- Or delete existing parameters:
  ```bash
  aws ssm delete-parameter --name /learning-navigator/github-owner
  aws ssm delete-parameter --name /learning-navigator/github-repo
