...
// WebSocket API endpoint for real-time chat communication (DEPRECATED - use HTTP_CHAT_API)
...
// HTTP Streaming Chat API endpoint (Lambda Function URL with response streaming)
