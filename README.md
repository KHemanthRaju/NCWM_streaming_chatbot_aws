...
## ⚡ 4-Command Deploy (Fastest - Recommended)

**Deploy in just 4 commands using AWS CodeBuild automation!** See [4-COMMAND-DEPLOY.md](4-COMMAND-DEPLOY.md)

**Prerequisites:** Upload your documents to an S3 bucket first (via AWS Console or CLI).
...
- [4-COMMAND-DEPLOY.md](4-COMMAND-DEPLOY.md) - ⚡ Fastest deployment using CodeBuild automation (~30 min)
